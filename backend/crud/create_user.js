...
const createUser = async (userData) => {
    try {
        ...
        // Default values for bio and social
        const defaultBio = {
        ...
        const postResult = await postsCollection.insertMany(defaultPosts);
        const messageResult = await messagesCollection.insertMany(defaultMessages);
